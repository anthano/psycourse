...
for cutoff, inner, outer in itertools.product(CUTOFFS, INNERS, OUTERS):
    ...
    summary_metrics_path: dict[str, Path] = {
        ...
        "clf_top20_summary_df": BLD_HURDLE / f"clf_top20_summary__{combination_id}.pkl",
        "reg_top20_summary_df": BLD_HURDLE / f"reg_top20_summary__{combination_id}.pkl",
    }
    ...
    def task_hurdle_aggregate(
        ...
        clf_top20_summary_df["feature_count"] = clf_top20_df["feature"].value_counts()
        ...
        reg_top20_summary_df["feature_count"] = reg_top20_df["feature"].value_counts()
